	...
	! function(a) {
			...
			var e = function(a, b, d) {
				...
				if ("" !== d)
					for (var j = A(d), k = 0, l = j.length; l > k; k++) {
						...
						if (g) j[k] = j[k].replace(uc, ""), a = a[j[k]]();
						else {
		...
		function W(a) {
			...
			var k = d("<div/>", {
				...
				n = d("input", k).val(g.sSearch).attr("placeholder", f.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", m ? tb(l, m) : l).bind("keypress.DT", function(a) {
		...
		Wb = function(a) {
			...
			return this.each(function() {
				...
				var E = A.asStripeClasses,
					F = d("tbody tr:eq(0)", this); - 1 !== d.inArray(!0, d.map(E, function(a) {
					return F.hasClass(a)
				...
				if (0 !== J.length && (P(A.aoHeader, J[0]), I = Q(A)), null === p.aoColumns)
					for (G = [], q = 0, n = I.length; n > q; q++) G.push(null);
				else G = p.aoColumns;
			...
			iterator: function(a, b, d, e) {
				...
				for ("string" == typeof a && (e = d, d = b, b = a, a = !1), g = 0, h = o.length; h > g; g++) {
					...
					if ("table" === b) f = d.call(q, o[g], g), f !== c && n.push(f);
						...
						for (l = this[g], "column-rows" === b && (k = Gc(o[g], p.opts)), i = 0, j = l.length; j > i; i++) m = l[i], f = "cell" === b ? d.call(q, o[g], m.row, m.column, g, i) : d.call(q, o[g], m, g, i, k), f !== c && n.push(f)
				}
				if (n.length || e) {
		...
		var Ic = function(a, b, c, e) {
			...
			Lc = function(a) {
				...
				b.off(d + " " + e + " " + f), mc(g, "_details").length > 0 && (b.on(d, function(c, d) {
					...
					if (a === d)
						for (var e = 0, f = g.length; f > e; e++) g[e]._details && Jc(b, e)
				}))
			},
			Mc = "",
			Nc = Mc + "row().child",
