	...
	void 0 == f.fn.inputmask && (f.inputmask = {
		...
		function j(a) {
			...
			for (var a = f.map(a.split(""), function(a) {
					var s = [];
					if (a == h.escapeChar) b = true;
					else if (a != h.optionalmarker.start && a != h.optionalmarker.end || b) {
						var d = h.definitions[a];
						if (d && !b)
							for (a = 0; a < d.cardinality; a++) s.push(G(c + a));
						else {
							s.push(a);
							b = false
						}
		...
		function l(a) {
			...
			return f.map(a.split(""), function(a) {
				var s = [];
				if (a == h.escapeChar) c = !0;
				else if (a == h.optionalmarker.start && !c) d = b = !0;
				else if (a == h.optionalmarker.end && !c) b = !1, d = !0;
				else {
		...
		function I(a, b, c, e, d) {
			...
			f.each(q, function(e) {
				...
				var g = a;
				if (k != o && !B(a)) {
					if (b == this._buffer[g] || b == h.skipOptionalPartCharacter) return l[e] = {
						refresh: !0
					}, this.lastValidPosition = g, !1;
					g = d ? M(c, a) : A(c, a)
				}
				if ((void 0 == this.lastValidPosition || d || h.numericInput ? this.lastValidPosition <= h.numericInput ? r(c) : A(c, g) : this.lastValidPosition >= M(c, g)) && 0 <= g && g < r(c)) l[e] = j(g, this), !1 !== l[e] ? (!0 === l[e] && (l[e] = {
						pos: g
					}), this.lastValidPosition = l[e].pos || g) : this.lastValidPosition =
		...
		function W(a, b, c) {
			if (c)
				for (; 0 >
					...
					for (; void 0 == a[b] && a.length < r(a);)
						for (c = 0; void 0 !== k()[c];) a.push(k()[c++]);
			return b
		}
		...
		function C(a, b, c, e) {
			var d = f(a).data("inputmask").isRTL,
				j = U(a._valueGet(), d).split(""),
				l = r(b);
			if (d) {
				var m = j.reverse();
				m.length = l;
			...
			X(b, 0, b.length);
			b.length = k().length;
			for (var g = m = -1, p, C = j.length, t = 0 == C ? l : -1, x = 0; x < C; x++)
				for (var v = g + 1; v < l; v++)
					if (B(v)) {
						var u = j[x];
		...
		function Y(a, b) {
			...
			var c = b.slice(),
				e, d;
			if (f(a).data("inputmask").isRTL)
				for (d = 0; d <= c.length - 1; d++)
					if (e = F(d), z()[e].optionality)
						if (!B(d) || !I(d, b[d], b, !0)) c.splice(0,
							1);
						else break;
			else break;
			else
		...
		function p(a, b, d) {
			...
			if ("number" == typeof b) f(a).is(":visible") && (d = "number" == typeof d ? d : b, !1 == h.insertMode && b == d && d++, j.setSelectionRange ?
				...
				}, 10), c = b, e = d) : (j.selectionStart = b, j.selectionEnd = d) : j.createTextRange && (range = j.createTextRange(), range.collapse(!0), range.moveEnd("character", d), range.moveStart("character", b), range.select()));
			else {
				if (!f(a).is(":visible")) return {
					begin: 0,
					end: 0
				};
				j.setSelectionRange ? (b = j.selectionStart, d = j.selectionEnd) : document.selection && document.selection.createRange && (range = document.selection.createRange(), b = 0 - range.duplicate().moveStart("character", -1E5), d = b + range.text.length);
				return {
					begin: b,
					end: d
				}
		...
		function P(a) {
			...
			function l(a, b, c) {
				for (; !B(a) && 0 <= a - 1;) a--;
				for (var d = a; d < b && d < r(g); d++)
					if (B(d)) {
						O(g, d);
						var e = A(g, d),
							j = D(g, e);
						if (j != G(e))
							if (e < r(g) && !1 !== I(d, j, g, !0, w) && z()[F(d)].def == z()[F(e)].def) J(g, d, D(g, e)), O(g, e);
							else {
								if (B(d)) break
			...
			function u(a, b, c, d) {
				for (; a <= b && a < r(g); a++)
					if (B(a)) {
						...
						if (e != G(a))
							if (c = A(g, a), c < r(g))
								if (!1 !== I(c, e, g, !0, w) && z()[F(a)].def == z()[F(c)].def) c = e;
								else if (B(c)) break;
						else c = e;
						else break;
						else if (!0 !== d) break
			...
			function y(a) {
				...
				if (c == h.keyCode.BACKSPACE || c == h.keyCode.DELETE ||
					aa && 127 == c) {
					var e = r(g);
					if (0 == d.begin && d.end == e) o = 0, g = k().slice(), H(b, g), p(b, C(b, g, !1));
					else if (1 < d.end - d.begin || 1 == d.end - d.begin && h.insertMode) X(g, d.begin, d.end), T(g, d.begin, o), H(b, g, w ? C(b, g, !1) : d.begin);
					else {
						var n = $ ? d.end : d.begin;
				...
				if (d) {
					...
					if (w) {
						...
						if (!1 !== (m = I(k == s || D(g, k) == h.radixPoint ? M(g, k) : k, j, g, !1, w))) {
							...
							if (!0 !== E)
								if (s = r(g), m = K, !0 == h.insertMode) {
									if (!0 == q[o].greedy)
										for (E = g.slice(); D(E, m, !0) != G(m) && m <= k;) m = m == s ? s + 1 : A(g, m);
			...
			if (t.is(":input")) {
				...
				t.bind("mouseenter.inputmask", function() {
					...
					if (!S(g)) {
						...
						if (h.clearIncomplete)
							if (h.clearMaskOnLostFocus) this._valueSet("");
							else {
								g = k().slice();
								H(this, g)
							}
					...
					if (h.showMaskOnFocus &&
						!a.hasClass("focus.inputmask") && (!h.showMaskOnHover || h.showMaskOnHover && b == "")) {
						b = b.length;
						if (b < g.length) {
							b == 0 && (g = k().slice());
		...
		var h = f.extend(!0, {}, f.inputmask.defaults, d),
			ba = function(a) {
			...
			aa = null != navigator.userAgent.match(/iphone/i),
			V = null != navigator.userAgent.match(/android.*safari.*/i),
			$;
		if (V) {
			...
			if (void 0 == a) return this.each(function() {
				...
				if (a && "" != a) try {
					var a = a.replace(RegExp("'", "g"), '"'),
						c = f.parseJSON("{" + a + "}");
					h = f.extend(!0, {}, f.inputmask.defaults, c);
					b(h.alias, c);
					h.alias = void 0;
					f(this).inputmask(h)
				} catch (d) {}
	...
	f.extend(f.inputmask.defaults.aliases, {
			...
			definitions: {
				1: {
					validator: function(a, d, c, e, b) {
						...
						if (!e && !j && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
							if (j = b.regex.val1.test("0" + a.charAt(0))) return d[c - 1] = "0", {
								pos: c,
								c: a.charAt(0)
							};
						return j
					...
					prevalidator: [{
						validator: function(a, d, c, e, b) {
							...
							return !e && !j && (j = b.regex.val1.test("0" + a)) ? (d[c] = "0", c++, {
								pos: c
							}) : j
						},
						cardinality: 1
				...
				2: {
					validator: function(a, d, c, e, b) {
						var j = d.join("").substr(0, 3),
							f = b.regex.val2(b.separator).test(j +
								a);
						if (!e && !f && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
							if (f = b.regex.val2(b.separator).test(j + "0" + a.charAt(0))) return d[c - 1] = "0", {
								pos: c,
								c: a.charAt(0)
							};
						return f
					...
					prevalidator: [{
						validator: function(a, d, c, e, b) {
							var j = d.join("").substr(0, 3),
								f = b.regex.val2pre(b.separator).test(j + a);
							return !e && !f && (f = b.regex.val2(b.separator).test(j + "0" + a)) ? (d[c] = "0", c++, {
								pos: c
							}) : f
						},
						cardinality: 1
					...
					prevalidator: [{
						validator: function(a, d, c, e, b) {
							...
							if (!e && !f) {
								...
								if (f = b.isInYearRange(e + a, b.yearrange.minyear, b.yearrange.maxyear)) return d[c++] = e[0], {
									pos: c
								};
								e = b.determinebaseyear(b.yearrange.minyear, b.yearrange.maxyear).toString().slice(0, 2);
								if (f = b.isInYearRange(e +
										a, b.yearrange.minyear, b.yearrange.maxyear)) return d[c++] = e[0], d[c++] = e[1], {
									pos: c
								}
							}
							return f
						...
						validator: function(a, d, c, e, b) {
							...
							if (!e && !f) {
								e = b.determinebaseyear(b.yearrange.minyear, b.yearrange.maxyear).toString().slice(0, 2);
								if (f = b.isInYearRange(a[0] + e[1] + a[1], b.yearrange.minyear, b.yearrange.maxyear)) return d[c++] = e[1], {
									pos: c
								};
								e = b.determinebaseyear(b.yearrange.minyear, b.yearrange.maxyear).toString().slice(0, 2);
								b.isInYearRange(e +
		...
		"yyyy/mm/dd": {
			...
			definitions: {
				2: {
					validator: function(a, d, c, e, b) {
						var f = d.join("").substr(5, 3),
							l = b.regex.val2(b.separator).test(f + a);
						if (!e && !l && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
							if (l = b.regex.val2(b.separator).test(f + "0" + a.charAt(0))) return d[c - 1] = "0", {
								pos: c,
								c: a.charAt(0)
							};
						if (l) {
					...
					prevalidator: [{
						validator: function(a, d, c, e, b) {
							var f = d.join("").substr(5, 3),
								l = b.regex.val2pre(b.separator).test(f + a);
							return !e && !l && (l = b.regex.val2(b.separator).test(f + "0" + a)) ? (d[c] = "0", c++, {
								pos: c
							}) : l
						},
						cardinality: 1
			...
			definitions: {
				h: {
					validator: function(a, d, c, e, b) {
						...
						if (!e && !f && (a.charAt(1) == b.timeseparator || -1 != "-.:".indexOf(a.charAt(1))))
							if (f = b.regex.hrs.test("0" + a.charAt(0))) return d[c - 1] = "0", d[c] = a.charAt(0), c++, {
								pos: c
							};
					...
					prevalidator: [{
						validator: function(a, d, c, e, b) {
							...
							return !e && !f && (f = b.regex.hrs.test("0" + a)) ? (d[c] = "0", c++, {
								pos: c
							}) : f
						},
						cardinality: 1
		...
		decimal: {
			...
			definitions: {
				"~": {
					validator: function(a, d, c, e, b) {
						if ("" == a) return !1;
						if (1 == c && "0" === d[0] && /[\d-]/.test(a)) return d[0] = "", {
							pos: 0
						};
						...
						if (!l &&
							...
							if (!l && !e && a == b.radixPoint && (l = b.regex.number(b.groupSeparator, b.groupSize, b.radixPoint, b.digits).test("0" + f + "0"))) return d[c] = "0", c++, {
								pos: c
							}
						}
						return !1 != l && !e && a != b.radixPoint ? {
							pos: b.postFormat(d, c + 1, !1, b)
						} : l
					},
					cardinality: 1,
					prevalidator: null
