...
(function(f, q) {
	f.fn.bootpag = function(p) {
		function k(e, b) {
			...
			g.last().toggleClass("disabled", b ===
				a.total).attr("data-lp", c).find("a").attr("href", h(c));
		...
		return this.each(function() {
			...
			a.next && (b = a.leaps && a.total > a.maxVisible ?
				Math.min(a.maxVisible + 1, a.total) : 2, d.push('<li data-lp="' + b + '" class="next"><a href="' + h(b) + '">' + a.next + "</a></li>"));
			d.push("</ul>");
