<?php 
	class personalController extends Controller{
		...
		function Insert_InfoAdicional(){
			...
			print_r($_GET['deporteSeleccionado']);
			/*$informacion_adicional = $this->ConvertirArray($_GET);
			echo json_encode($informacion_adicional); die();
			$this->_personal->insertPersonModel($informacion_adicional);*/
